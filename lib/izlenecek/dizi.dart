...
class _DiziState extends State<Dizi> {
  TextEditingController diziController = TextEditingController();
            ...
            Container(
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('lib/assets/ayı.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
  ...
  FloatingActionButton floatingActionButtonWidget(BuildContext context) {
    return FloatingActionButton(
      onPressed: () {
        diziController.clear();
        showDialog(
          context: context,
          builder: (context) => AlertDialog(
            content: TextFormField(
              controller: diziController,
            ...
            actions: [
              TextButton(
                  onPressed: () {
                    if (diziController.text.isEmpty) {
                      showDialog(
                        context: context,
                        builder: (context) => AlertDialog(
                          title: Text("UYARI"),
                      ...
                      setState(() {
                        toDoList.add({"title": diziController.text, "checked": false});
                        Navigator.pop(context);
                      });
                    }
                  },
